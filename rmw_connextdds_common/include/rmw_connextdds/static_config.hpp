...
#ifndef RMW_CONNEXT_HAVE_UNIQUE_NETWORK_FLOW_ENDPOINTS
#define RMW_CONNEXT_HAVE_UNIQUE_NETWORK_FLOW_ENDPOINTS \
  (RMW_CONNEXT_RELEASE > RMW_CONNEXT_RELEASE_FOXY)
#endif /* RMW_CONNEXT_HAVE_UNIQUE_NETWORK_FLOW_ENDPOINTS */

#ifndef RMW_CONNEXT_HAVE_GET_NETWORK_FLOW_ENDPOINTS
#define RMW_CONNEXT_HAVE_GET_NETWORK_FLOW_ENDPOINTS \
  (RMW_CONNEXT_RELEASE > RMW_CONNEXT_RELEASE_FOXY)
