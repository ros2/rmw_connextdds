...
#ifndef RMW_DDS_COMMON__TOPIC_ENDPOINT_INFO_ARRAY_H_
#define RMW_DDS_COMMON__TOPIC_ENDPOINT_INFO_ARRAY_H_
...
#endif    // RMW_DDS_COMMON__TOPIC_ENDPOINT_INFO_ARRAY_H_
